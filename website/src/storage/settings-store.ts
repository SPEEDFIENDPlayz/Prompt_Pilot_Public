...
import type { ProcessingLevel, TranscriptionMode } from "../core/types";

const DATABASE = "prompt-pilot-mobile";
const STORE = "settings";
const KEY = "current";

export interface Settings { geminiApiKey?: string; level: ProcessingLevel; introSeen: boolean; transcriptionMode: TranscriptionMode }
const defaults = (): Settings => ({ level: DEFAULT_LEVEL, introSeen: false, transcriptionMode: "auto" });
