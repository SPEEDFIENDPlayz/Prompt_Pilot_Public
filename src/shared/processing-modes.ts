...
export const PROCESSING_MODES: Record<ProcessingLevel, { label: string; instruction: string }> = {
  1: {
    label: "Natural human",
    instruction:
